...
export type ClientMsg =
  ...
  | { v: number; type: 'intent'; action: Action; intentId?: number }
  | { v: number; type: 'leave' }
...
export type ServerMsg =
  ...
  | { v: number; type: 'view'; view: PlayerView; notices?: PublicNotice[]; intentId?: number }
  | { v: number; type: 'error'; message: string; intentId?: number }
